function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        /* TODO: Questjion 1.1: Starts here */
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var passEqualsConfPass = (myInput.value); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (enableButton); // TODO: Replace false with the correct condition
    if(condition) {       
